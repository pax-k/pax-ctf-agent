...
Preserve the original lane, tool or skill, timestamp, validation state, and
evidence path for every claim. Do not relabel HexStrike output as a
Strix-validated finding. Remove flags, credentials, personal data, and target
details before creating public material.
